...
/** Constructs a new variant with an long long value, val. */
Variant::Variant ( long long val )
: QVariant( val )
{
}

/** Constructs a new variant with an unsigned long long value, val. */
...
/** Constructs a new variant with a variant value, val. */
Variant::Variant ( const QVariantList & val )
: QVariant( val )
{
}
...
QString Variant::pprint( int column )
{
    ...
    case LongLong:
    case ULongLong:
        items << QString::number( toLongLong() );
        break;
